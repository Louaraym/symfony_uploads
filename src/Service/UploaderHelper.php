...
class UploaderHelper
{
    ...
    public function __construct(FilesystemInterface $privateUploadsFilesystem, FilesystemInterface $publicUploadsFilesystem, RequestStackContext $requestStackContext, LoggerInterface $logger, string $uploadedAssetsBaseUrl)
    {
